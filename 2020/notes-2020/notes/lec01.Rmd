...
knitr::include_graphics("imgs/2017/data-science-explore.png")
```
...
knitr::include_graphics("imgs/2018/tidyverse.png")
```
...
knitr::include_graphics("imgs/2018/tidy2.png")
```
...
### Keep it Flexiable
- I hope to cover some ad-hoc practical topics if time is allowed.


## Assingment

- 4 individual assignments + 1 group assignment. No exam.
- Due date: +10 days. The following week's weekend.
...
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics("imgs/2018/assignment-org.png")
```


## Submission by sharing

  - Share "FE8828-Your Name" with *yy@runchee.com* on Google drive, or *yangye@ntu.edu.sg* with NTU One Drive.
  - Share once. No need to share weekly. I will retrieve the files after due date.
    
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics("imgs/2020/share_one_drive.png")
```

## My marking considerations
...
1. Correctness and Completeness. (a must)
2. Write functions, reduce copy&paste (necessary)
3. Efficiency and Performance (good to have)

## Keep calm and code on

```{r echo = FALSE, out.width = "30%"}
knitr::include_graphics("imgs/2017/keep-calm-code-on.jpg")
```
...
knitr::include_graphics("imgs/2017/Internet_map_1024.jpg")
```

## Network is to connect the dots/devices

```{r echo = FALSE, out.width = "40%", fig.show='hold', fig.align='center'}
knitr::include_graphics(c("imgs/2017/dot-to-dot-connect-the-dots.jpg", "imgs/2017/network_connect_dots.jpg"))
```
...
```{r echo = FALSE, out.width = "40%"}
knitr::include_graphics("imgs/2017/Common-network-topologies.png")
```
...
knitr::include_graphics("imgs/2017/cables.jpg")
```
...
```{r echo = FALSE, out.width = "60%"}
knitr::include_graphics("imgs/2017/tcp_header.png")
```
...
knitr::include_graphics("imgs/2017/375px-TCP_CLOSE.svg.png")
```

DHCP Session

```{r echo = FALSE, out.width = "22%"}
knitr::include_graphics("imgs/2017/DHCP_session.svg.png")
```
...
```{r echo = FALSE, out.width = "70%"}
knitr::include_graphics("imgs/2017/wireshark-packets.jpg")
```
...
knitr::include_graphics("imgs/2017/640px-UDP_encapsulation.svg.png")
```

4. Application layer runs many protocols

```{r echo = FALSE, out.width = "35%"}
knitr::include_graphics("imgs/2017/tcp-ip.png")
```
...
knitr::include_graphics("imgs/2017/internet-host-count.png")
```

- IETF (Internet Engineering Task Force) maintains and still gets new protocol approved.

```{r echo = FALSE, out.width = "25%"}
knitr::include_graphics("imgs/2018/ietf-card.png")
```
...
knitr::include_graphics("imgs/2017/jediocto.jpg")
```
...
knitr::include_graphics("imgs/2017/Wikimedia_donation_page_with_extended_validation_certificate_in_firefox.png")
```
...
knitr::include_graphics("imgs/2017/mosaic-browser.jpg")
```
...
knitr::include_graphics("imgs/2017/HTML5_CSS_JavaScript.png")
```
...
```{r echo = FALSE, out.width = "25%"}
knitr::include_graphics("imgs/2017/heisencat.png")
```
...
knitr::include_graphics("imgs/2017/Markdown-mark.svg.png")
```
...
cat(htmltools::includeText("../example/week1/markdown-example.md"))
```

## Markdown output example

```{r echo = FALSE, out.width = "47%"}
knitr::include_graphics("imgs/2017/markdown-doc-preview.png")
```
...
knitr::include_graphics("imgs/2017/professortocat.png")
```
...
```{r echo = FALSE, out.width = "9%"}
knitr::include_graphics("imgs/2017/gangnamtocat.png")
```
...
knitr::include_graphics("imgs/2017/ironocto.png")
```
...
knitr::include_graphics("imgs/2017/megacat-2.png")
```
...
```{r echo = FALSE, out.width = "9%"}
knitr::include_graphics("imgs/2017/ninjacat.jpg")
```
...
A link immediately preceded by a ! will be treated as an image. The link text will be used as the image's alt text:
    ...
    ![Pizza](imgs/2017/bitcoin-pizza.png)

```{r echo = FALSE, out.width = "9%"}
knitr::include_graphics("imgs/2017/ski-octo.png")
```

![Pizza](imgs/2017/bitcoin-pizza.png){width=40%}
...
- Inline with text, `$x = \frac{-b \pm \sqrt{b^2-4ac}}{2a}$`, $x = \frac{-b \pm \sqrt{b^2-4ac}}{2a}$
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/rmd-example-doc.Rmd"))
```
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-1-empty.R"))
```
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-2-sidebar.R"))
```
...
\scriptsize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-3-sidebar-min.R"))
```
...
\tiny
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-3-sidebar.R"))
```
...
\scriptsize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-4-wellPanel.R"))
```
...
\scriptsize
```{r echo = FALSE, comment = ""} 
cat(htmltools::includeText("../example/week1/shiny-5-navPanel.R"))
```
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-6-tabPanel.R"))
```
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-7-navbar.R"))
```
...
\tiny
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-8-column.R"))
```
...
\tiny
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-10-composite.R"))
```
...
\footnotesize
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("../example/week1/shiny-mfe-example.Rmd"))
```
...
```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("imgs/2017/runchee.png")
```
...
```{r echo = FALSE, out.width = "12%"}
knitr::include_graphics("imgs/2017/Rlogo.png")
```

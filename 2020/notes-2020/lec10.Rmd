...
subtitle: "Week 4: 1. ggplot2: Data Visualization and EDA 2. R Shiny/3: Reactive"
date: "Oct 8, 2020"
...
knitr::include_graphics("imgs/2017/ggplot2-basics.png")
```
...
cat(htmltools::includeText("example/week4/shiny-36-update.R"))
```
...
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("example/week4/shiny-34-renderUI.R"))
```
...
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("example/week4/shiny-35-renderUI-2.R"))
```

## Create dynamic output 3

```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("example/week4/shiny-32-renderUI.R"))
```
...
```{r echo = FALSE, comment = ""}
cat(htmltools::includeText("example/week4/shiny-37-createDynamic.R"))
```

...
<center>![](imgs/2017/block-hash.png "Block hash"){width=45%}</center>


## Block chain
The next block contains the previous block's hash
<center>![](imgs/2017/block-chain.png "blockchain"){width=45%}</center>
...
<center>![](imgs/2017/block-head.jpg "Block head"){width=45%}</center>
...
<center>![](imgs/2017/block-head-chain.jpg "Block head chain"){width=45%}</center>
...
- Hash1 and
- Hash23
<center>![](imgs/2017/merkle-tree-veri.png "merkle tree verification"){width=45%}</center>

More illustrative example.
https://media.consensys.net/ever-wonder-how-merkle-trees-work-c2f8b7100ed3
<center>![](imgs/2017/merkle-banana.png "Merkle tree in banana"){width=45%}</center>

<center>![](imgs/2017/merkle-tree-aa.jpg "Merkle tree AA"){width=45%}</center>
...
<center>![](imgs/2017/merkle-tree-ab.jpg "Merkle tree AB"){width=45%}</center>
...
<center>![](imgs/2017/bft-paper-front.png "bft-paper-front"){width=45%}</center>
...
<center>![](imgs/2017/bft-general.png "bft-general"){width=45%}</center>
...
<center>![](imgs/2017/general-message.png "general-message"){width=45%}</center>
...
<center>![](imgs/2017/confirmation-time.png "confirmation-time"){width=45%}</center>
<center>![](imgs/2017/bitcoin-difficulty.png "bitcoin-difficulty"){width=45%}</center>

...
date: "Oct 29, 2018"
subtitle: <sub> Week 1 <br> What's Internet? What's Web? <br> Launch into the Cloud
  <br> R Markdown and Shiny layout </sub>
---
...
IETF (Internet Engineering Task Force) maintains and still get new protocol approved.
```{r, echo = FALSE, out.width = "40%"}
...
# Lecture 3: R Markdown and Shiny (layout)
## Introduction

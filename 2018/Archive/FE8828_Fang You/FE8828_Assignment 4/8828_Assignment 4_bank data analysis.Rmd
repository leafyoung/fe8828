...
ggplot(bank, aes(x = age, fill = marital)) +
  ...
  labs(title = "Marital status of bank clients across age group")
...
ggplot(hyp5, aes(x = month, y = success_rate,fill = success_rate)) + 
  geom_col() + 
...
ggplot(hyp8,aes(x=pmonths,y=success_rate,alpha = success_rate)) +
  geom_col() +
  theme_minimal()

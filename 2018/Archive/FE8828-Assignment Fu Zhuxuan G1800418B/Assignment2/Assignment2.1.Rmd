...
make_choice <- function(N, split_number){
  # YY: Vector is faster then list.
  # YY: remove as.list, unlist in below code.
  ...
  if (split_number == 0){
    ...
    # YY: you may save the if below by setting result <- selection[length(selection)] here.
    result <- 0
    for (i in selection){
      if (i>=eval_best){
        result <- i
  ...
  # YY: This is good to handle the not-found case.
  if (result == 0){

...
# How does this course affect your career?
An intro to data science

## One kind of pipeline
...
Windows: Download Git for Windows from https://git-scm.com/download/.
ssh -i 'c:\Users\yourusername\Downloads\MyKeyPair.pem' ec2-user@{IP_Address}

Mac: skip download Git. Go straight
ssh -i ~/Downloads/MyKeyPair.pem ec2-user@{IP_Address} 

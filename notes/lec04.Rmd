...
* Use days_in_month to determine leap year?
...
Return data
    return_lots_of_work <- function() {
      ...

      list(a = res_a, b = res_b )
    }

    res <- return_lots_of_work()
    res$a
    res$b
...
# debug Shiny
Clear all variable to run shiny

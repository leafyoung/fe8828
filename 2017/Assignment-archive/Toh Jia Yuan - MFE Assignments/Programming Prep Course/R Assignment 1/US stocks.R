...
GEClose <- df$GEClose # extract column
XOMClose <- df$XOMClose # extract column
SBUXClose <- df$SBUXClose # extract column
MCDClose <- df$MCDClose # extract column
AAPLClose <- df$AAPLClose # extract column

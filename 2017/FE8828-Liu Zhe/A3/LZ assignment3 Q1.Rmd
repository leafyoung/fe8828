...
```{r Finding5, echo = FALSE, warning = FALSE}
...
```{r Finding8, echo = FALSE, warning = FALSE}
...
```{r Finding9, echo = FALSE, warning = FALSE}
...
```{r Finding10, echo = FALSE, warning = FALSE}

...
```{r displayTable, echo = FALSE }
knitr::kable(select(FullTable,-1), caption = "Options")
```

## Part 2a: Count total value of Call/Put
### "Total Valuation" calculated by: Quantity (i.e. Open Int) * Price
```{r Valuation, echo = FALSE, warning = FALSE}
...
knitr::kable(InMoneyTable, caption = "In-The-Money Options")
```

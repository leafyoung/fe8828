...
data <- read_excel("D:/gdrive/MFECourse/FE8828/2017/FE8828-Zheng Chen/ZhengChenAssignment3/Rassignment3data.xlsx")
...
ggplot(option2) + 
  geom_point(data=dplyr::filter(option2, type=="c"), aes(Strike, Vol), color="blue") +
  geom_point(data=dplyr::filter(option2, type=="p"), aes(Strike, Vol), color="green") 

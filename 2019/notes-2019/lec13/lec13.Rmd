...
knitr::include_graphics("../new2019/comic-stat-vs-ml.jpg")
```
...
knitr::include_graphics("../new2019/Caret-package-in-R.png")
```
...
knitr::include_graphics("../new2019/applied-predictive-modeling-book-cover.png")
```

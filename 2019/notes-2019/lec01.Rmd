---
title: "FE8828 Programming Web Applications in Finance <br> <br> - Session 1 -"
subtitle: "<sub> What's Internet? What's Web? <br> Launch into the Cloud <br> R Markdown and Shiny layout </sub>"
...
<center> Theory <-> Programming <-> Practices </center>

* Programming is pratices of theory.
* A well-designed software framework is a guide to pratices.
* The reason to learn programming is bi-folded:
    * We can code our own thoughts, and
    * We can utilize other people's work.
* We will build on beginner R to the imtermeidate/advanced R
* You will have ample exercise in this course - for your own learning.

# Data Science workflow

<center> Data -> Model -> Application </center>
...
# Assingments
- Week 1: A static website: a front page, an about page and some description pages. (due by week 2)
- Week 2: Shiny web application. (due by week 3)
...
<center>![](imgs/640px-UDP_encapsulation.svg.png "UDP"){width=27%}</center>

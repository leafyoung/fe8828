---
title: "FE8828 Programming Web Applications in Finance <br> <br> - Session 2 -"
subtitle: "<sub> Intermediate R Programming <br> Shiny/2: R Web Framework <br> Data Manipulation and EDA/1 </sub>"
...
Let's review some R basics and bring us to intermediate level of R programming. There are following topics:
...
- There is `print()` but I use `cat(paste0(..., "\n"))` most.
...
Regular Expression's Cheatsheat is available at <https://www.rstudio.com/resources/cheatsheets/>
...
```{r, echo = TRUE}
as.Date("2019-11-03", format = "%Y-%m-%d") # %m for number month
as.Date("2019-Nov-03", format = "%Y-%b-%d") # %b for the 3-letter month
as.Date("03Nov2019", format = "%d%b%Y")
```
...
length(bizseq("2019-10-01", "2019-10-31", cal = "weekends"))
...
bizdays("2019-10-01", "2019-10-31", cal = "weekends")
# One day less
bizdays("2019-10-01", "2019-10-31", cal = "MFE_Mini_2")
```
...
# Data frame extraction with `drop =`

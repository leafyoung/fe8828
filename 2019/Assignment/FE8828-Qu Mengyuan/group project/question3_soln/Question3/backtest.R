...
library(fOptions)
library(xts)
vol <- read_excel("~/Desktop/NTU/PROGRAMMING WEB APPLICATIONS IN FINANCE/FE8828-Qu Mengyuan/group project/VXAZNCLS.xls", 
                    sheet = "Sheet1")
close <- read_excel("~/Desktop/NTU/PROGRAMMING WEB APPLICATIONS IN FINANCE/FE8828-Qu Mengyuan/group project/VXAZNCLS.xls", 

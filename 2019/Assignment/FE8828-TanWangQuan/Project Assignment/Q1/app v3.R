...
# There is no repayment of credit in our assumption, and we assume that all clients have a high credit limit. Hence sum of credit is monotonically increasing.
...
# This suggestion is proposed due to the following advantages. Credit limit changes can be easily tracked, the credit amount a person has left can be easily calculated,
